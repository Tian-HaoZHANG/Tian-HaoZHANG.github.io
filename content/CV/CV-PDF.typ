...
#text(
  weight: "regular",
  size: 0.9em,
)[PhD student majoring in space plasma physics, supervised by Professor Xu-Zhi Zhou (周煦之)\
  Institute of Space Physics and Applied Technology, Peking University, China
]
