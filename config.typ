...
#let template = tufted.tufted-web.with(
  ...
  header-elements: (
    [Hello,],
    [welcome to Tian-Hao Zhang (张天昊)'s homepage!],
  ),
  /// 自定义页脚元素列表 (content 数组)，显示在页面底部。
  footer-elements: (
    [#math.copyright #datetime.today().display() Tian-Hao Zhang (张天昊)],
    [Powered by #link("https://github.com/Yousa-Mirage/Tufted-Blog-Template")[Tufted-Blog-Template], thanks to #link("https://github.com/Yousa-Mirage/")[Yousa-Mirage].],
  ),
)
